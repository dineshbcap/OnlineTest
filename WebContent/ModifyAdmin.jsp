...
<body
	...
	<form method="post" action="CommonServlet" name="frm"
		...
		<center>
			<center>
				<h3>
					<u>Modify Admin Details</u>
				</h3>
			</center>
			<table cellspacing="10px">
				<tr>
					<td align="right">User Name</td>
					<td><select style="width: 200px" name="selectedName"
						id="selectedName" onchange="getDetailOfAdminOrUser('admin')">
							<option selected="selected" value="-select-">-select-</option>
							<c:forEach items="${sessionScope.listOfAdmin}" var="username">
								<c:choose>
					...
					<td><c:choose>
							...
							<c:when test="${param.firstName!=null}">
								<input type="text" name="userName" id="userName"
									value="${param.firstName}" size="20" maxlength="15"
									onkeyup="return checkUserName1()">
							</c:when>
							<c:otherwise>
								<input type="text" name="userName" id="userName"
					...
					<td><c:choose>
							...
							<c:when test="${param.emailId!=null}">
								<input type="text" name="emailId" id="emailId" size="20"
									maxlength="35" value="${param.emailId }"
				...
				<tr>
					...
					<td><input type="password" name="rePassWord" id="rePassWord"
						value="" size="20" maxlength="10" onblur="checkRePassWord()">
				...
				<tr>
					...
					<td><c:choose>
							...
							<c:when test="${param.organizationName!=null}">
								<select style="width: 200px" name="selectedOrganizationName"
									id="selectedOrganizationName"
									onclick="checkOrganizationName1()" disabled="disabled">
									<option>-select-</option>
									<c:forEach items="${sessionScope.listOfOrganization}"
										var="name">
										<c:choose>
				...
				<tr>
					...
					<td><input type="checkbox" name="isAdmin" id="isAdmin"
						onclick="hideSelect()" checked="checked">
				</tr>
				<tr></tr>
				<tr>
					<td></td>
